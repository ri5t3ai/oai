...
pub use models::{
    Choice, CompletionResponse, Embedding, EmbeddingValue, EmbeddingsResponse, GenerateRequest,
    GenerateResponse, Logprobs, Model, ModelsResponse, TrainingResponse, TrainingStatusResponse,
};
...
impl OpenAI {
    ...
    pub async fn list_models(&self) -> Result<ModelsResponse, String> {
        ...
        let response_body: ModelsResponse =
    ...
    pub async fn get_embeddings(
        ...
        let response_body: EmbeddingsResponse =
            serde_json::from_str(&body).map_err(|err| err.to_string())?;
    ...
    pub async fn check_training_status(
        &self,
        model: &str,
        training_id: &str,
        ...
        let response_body: TrainingStatusResponse =
            serde_json::from_str(&body).map_err(|err| err.to_string())?;
    ...
    pub async fn create_training(
        ...
        let data = Data {
            ...
            name,
            model: model_id,
            validation_data: Some(TrainingData {
        ...
        let response_body: TrainingResponse =
            serde_json::from_str(&body).map_err(|err| err.to_string())?;
